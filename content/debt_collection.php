...
<html lang="en">
                        ...
                        <div class="card-body">
                          ...
                          <div class="row">
                              ...
                              <div class="table-responsive">          
                                ...
                                $sql=mysqli_query($conn,"SELECT * FROM temp_collection");
                                  ...
                                  if($row_num > 0) {
                                    ...
                                    <input type = "number" class="form-control text-right check"  style="width: 100px;" name = '.$id.' id="pay'.$id.'">
                                    </td>';
                                    echo ' <td style="text-align:right;">
                                    <input type = "number" class="form-control text-right"  style="width: 100px;" id="payable'.$id.'" value="'.$payable.'" readonly>
                                    </td>';
                                    echo ' <td style="text-align:right;">
                                    <input type = "number" class="form-control text-right"  style="width: 100px;" id="arrears'.$id.'" value="'.$arrears.'" readonly>
                                    </td>';
                                    echo ' <td style="text-align:right;">
                                    <input type = "number" class="form-control text-right"  style="width: 100px;" id="balance'.$id.'" value="'.$balance.'" readonly>
                                    </td>';
                            ...
                            <!--</div>
                              ...
                              <button type="button"  onclick="printForm()" class="btn btn-info btn-fw" >PRINT</button>                          
  ...
  <script>
    ...
    function printForm(){
        ...
        var center_id = $('#center_id').val();
        var li_date = $('#li_date').val();
        window.open('debt_collection_print.php?center='+center_id+'&createDate='+li_date, '_blank');
    }
